...
const GEMINI_API_KEY = "AIzaSyDQsJrcat_eENtfkCW2yuWxUFQbOxd0I0c"; // Replace with your Gemini API Key
...
app.post("/summary", async (req, res) => {
  try {
    ...
    const model = genAI.getGenerativeModel({ model: "gemini-2.0-flash" }); // Or gemini-1.0-pro / flash
